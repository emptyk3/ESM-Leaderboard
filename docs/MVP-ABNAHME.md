...
| Migrationskette            | Leeres Schema und bestehender Produktionsstand                                                           | Prisma-Schema-Diff, Validierung und erfolgreiche Production-Deployments                               | Schema verifiziert; kompletter Neuaufbau auf isoliertem PostgreSQL manuell abnehmen |
...
Auf dem Abnahmerechner waren weder PostgreSQL noch Docker installiert und es
stand kein freigegebener Neon-Testbranch zur Verfügung. Der Prisma-Diff von
einem leeren Zustand zum aktuellen Schema, alle vier Migrationen im Repository
und die fortlaufend erfolgreichen Production-Migrationsdeployments wurden
geprüft. Ein tatsächlicher Neuaufbau der gesamten Kette bleibt deshalb Teil der
isolierten manuellen Infrastrukturabnahme und wurde nicht gegen Produktion
simuliert.
